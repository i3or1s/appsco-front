    ...
    return html`
        ...
        <paper-card heading="Authorized applications" id="card">
            ...
            <div class="card-content layout vertical">
                ...
                <appsco-account-authorized-apps id="appscoAccountAuthorizedApps" account="[[ account ]]" authorization-token="[[ authorizationToken ]]" authorized-apps-api="[[ authorizedAppsApi ]]" size="5" load-more="">
