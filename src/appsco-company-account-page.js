...
import './company-account/appsco-company-account-page-actions.js';
...
class AppscoCompanyAccountPage extends mixinBehaviors([
  ...
  static get template() {
    return html`
        ...
        <appsco-account-authorized-app-revoke id="appscoAccountAuthorizedAppRevoke" authorization-token="[[ authorizationToken ]]">
