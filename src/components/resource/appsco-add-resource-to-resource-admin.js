    ...
    return html`
        ...
        <paper-dialog id="dialog" entry-animation="scale-up-animation" exit-animation="fade-out-animation" on-iron-overlay-opened="_onDialogOpened" on-iron-overlay-closed="_onDialogClosed">
            ...
            <div class="filter-resources">
                <appsco-search id="appscoSearch" label="Search for resources" float-label="" on-search="_onSearchResources" on-search-clear="_onSearchResourcesClear"></appsco-search>

                <paper-dropdown-menu horizontal-align="left" on-iron-activate="_onResourceTypeSelected" on-iron-overlay-opened="_onInnerIronOverlay" on-iron-overlay-closed="_onInnerIronOverlay">
                        ...
                        <table>
                            ...
                            <tbody>
                                <template is="dom-repeat" items="[[ _resourceList ]]">
                                    <tr>
                                        <td>
                                            <appsco-resource-list-item item="[[ item ]]" on-select-item="_onResourceListItemSelectChanged"></appsco-resource-list-item>
                                        </td>
