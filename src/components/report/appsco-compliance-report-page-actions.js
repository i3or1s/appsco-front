...
import './appsco-compliance-report-actions.js';
import { html } from '@polymer/polymer/lib/utils/html-tag.js';
import { mixinBehaviors } from '@polymer/polymer/lib/legacy/class.js';
import { PolymerElement } from '@polymer/polymer/polymer-element.js';
class AppscoComplianceReportPageActions extends mixinBehaviors([NeonAnimatableBehavior], PolymerElement) {
  static get template() {
    return html`
        <style include="shared-styles">
            ...
            appsco-compliance-report-actions {
                margin-right: 10px;
            }
        ...
        <appsco-compliance-report-actions></appsco-compliance-report-actions>
...
`;
  ...
  static get is() { return 'appsco-compliance-report-page-actions'; }
...
window.customElements.define(AppscoComplianceReportPageActions.is, AppscoComplianceReportPageActions);
