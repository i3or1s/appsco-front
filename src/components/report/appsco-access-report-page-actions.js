...
import './appsco-access-report-actions.js';
import { html } from '@polymer/polymer/lib/utils/html-tag.js';
import { mixinBehaviors } from '@polymer/polymer/lib/legacy/class.js';
import { PolymerElement } from '@polymer/polymer/polymer-element.js';

class AppscoAccessReportPageActions extends mixinBehaviors([NeonAnimatableBehavior], PolymerElement) {
    static get template() {
        return html`
        ...
        <appsco-access-report-actions></appsco-access-report-actions>
...
`;
    ...
    static get is() { return 'appsco-access-report-page-actions'; }
...
window.customElements.define(AppscoAccessReportPageActions.is, AppscoAccessReportPageActions);
