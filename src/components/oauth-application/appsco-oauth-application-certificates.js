...
import './appsco-oauth-application-certificate-item.js';
...
class AppscoOAuthApplicationCertificates extends mixinBehaviors([AppscoListBehavior], PolymerElement) {
    static get template() {
        return html`
            ...
            <template is="dom-if" if="[[ !_listEmpty ]]">
                <div class="list">
                    <template is="dom-repeat" items="[[ _listItems ]]" on-dom-change="_onItemsDomChange">
                        ...
                        <appsco-oauth-application-certificate-item id="appscoListItem_[[ index ]]" item="[[ item ]]" type="[[ type ]]" list-api="[[ listApi ]]" authorization-token="[[ authorizationToken ]]" selectable="[[ selectable ]]" preview="[[ preview ]]" on-item="_onListItemAction" on-select-item="_onSelectListItemAction"></appsco-oauth-application-certificate-item>
...
`;
    ...
    static get is() { return 'appsco-oauth-application-certificates'; }
...
window.customElements.define(AppscoOAuthApplicationCertificates.is, AppscoOAuthApplicationCertificates);
