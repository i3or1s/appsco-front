...
class AppscoIPWhitelistPolicySettings extends mixinBehaviors([Appsco.HeadersMixin], PolymerElement) {
    static get template() {
        return html`
        <style>
            :host {
...
`;
    ...
    static get is() { return 'appsco-ip-whitelist-policy-settings'; }
...
window.customElements.define(AppscoIPWhitelistPolicySettings.is, AppscoIPWhitelistPolicySettings);
