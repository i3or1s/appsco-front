...
class AppscoGroupContactsPage extends mixinBehaviors([AppscoGroupItemsPageBehavior, NeonSharedElementAnimatableBehavior], PolymerElement) {
    static get template() {
        return html`
        ...
        <paper-card heading="Contacts" id="card">
            ...
            <div class="card-content layout vertical">
                ...
                <appsco-company-group-contacts id="appscoCompanyGroupItems" class="group-item-list" group="[[ group ]]" list-api="[[ groupContactsApi ]]" authorization-token="[[ authorizationToken ]]" size="10" load-more=""></appsco-company-group-contacts>
...
`;
    ...
    static get is() { return 'appsco-group-contacts-page'; }
...
window.customElements.define(AppscoGroupContactsPage.is, AppscoGroupContactsPage);
