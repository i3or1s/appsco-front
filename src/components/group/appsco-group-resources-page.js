...
class AppscoGroupResourcesPage extends mixinBehaviors([AppscoGroupItemsPageBehavior, NeonSharedElementAnimatableBehavior], PolymerElement) {
    static get template() {
        return html`
        ...
        <paper-card heading="Resources" id="card">
            ...
            <div class="card-content layout vertical">
                ...
                <appsco-company-group-resources id="appscoCompanyGroupItems" class="group-item-list" group="[[ group ]]" list-api="[[ groupResourcesApi ]]" authorization-token="[[ authorizationToken ]]" size="10" load-more=""></appsco-company-group-resources>
...
`;
    ...
    static get is() { return 'appsco-group-resources-page'; }
...
window.customElements.define(AppscoGroupResourcesPage.is, AppscoGroupResourcesPage);
