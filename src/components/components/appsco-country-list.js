...
class AppscoCountryList extends PolymerElement {
    ...
    ready() {
        ...
        beforeNextRender(this, function() {
            this.set('types', this.ccTypes().sort(this._compareCountryByName));
        });
    }

    _compareCountryByName(countryA, countryB) {
...
window.customElements.define(AppscoCountryList.is, AppscoCountryList);
