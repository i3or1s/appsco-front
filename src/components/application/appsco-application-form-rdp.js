...
class AppscoApplicationFormRdp extends mixinBehaviors([AppscoApplicationFormBehavior], PolymerElement) {
    static get template() {
        ...
        <paper-input id="domain" 
            ...
            data-field="" ></paper-input>
        <paper-button id="advancedRDPSettings" role="button" tabindex="0" animated="" elevation="1" raised aria-disabled="false"
            on-tap="_toggleAdvancedSettings"
        >Advanced Settings</paper-button>    
        <iron-collapse id="advancedRDPSettingsCollapse"> 
...
`;
    ...
    _toggleAdvancedSettings() {
        this.shadowRoot.getElementById('advancedRDPSettingsCollapse').toggle();
    }
}
