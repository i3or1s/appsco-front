...
import './appsco-company-brand-settings.js';
...
class AppscoCompanyBrandSettingsPage extends mixinBehaviors([NeonSharedElementAnimatableBehavior], PolymerElement) {
    static get template() {
        ...
        <paper-card heading="Brand settings" id="companyBrandSettings">
            <paper-icon-button icon="close" title="Close" class="page-close-action" on-tap="_onBack"></paper-icon-button>

            <div class="card-content">
                <appsco-company-brand-settings id="appscoCompanyBrandSettings" company="[[ company ]]" authorization-token="[[ authorizationToken ]]" settings-api="[[ settingsApi ]]" image-settings-api="[[ imageSettingsApi ]]" dashboard-image-settings-api="[[ dashboardImageSettingsApi ]]"></appsco-company-brand-settings>
            </div>
        </paper-card>
`;
    }
